...
import { TrendingUp, Wallet, Banknote, Users, Truck, Package, AlertTriangle, ArrowDownToLine, ArrowUpFromLine, Activity, ShoppingBag, UserCheck } from "lucide-react";
              ...
              stats.recentSales?.map((sale: any) => (
                <div key={sale.id} className="flex items-center justify-between p-3 bg-background rounded-xl border border-border hover:border-primary-blue/30 transition-colors">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-semibold text-text-primary text-sm">{sale.customers?.[0]?.name || sale.customers?.name || "عميل نقدي"}</p>
